...
Route::get('/home/video/all',       'RORK\CategoryController@CategoryVid');

Route::get('/home/video/all2',       'RORK\CategoryController@CategoryVid');
...
Route::get('/rork/videos/format/categories',  'RORK\CategoryController@formatCategory');
...
Route::get('/rork/product/single/{product_id},{user_id}',  'RORK\ProductController@productDetails');
